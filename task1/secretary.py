...
def add_unit(documents_list, directories_dict):
    user_input_type = get_input('Введите вид документа: ')
    user_input_number = get_input('Введите номер документа: ')
    user_input_name = get_input('Введите имя владельца: ')
    user_input_storage_place = get_input('Введите номер полки для хранения документа: ')
